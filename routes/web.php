...
Route::group(['as' => 'admin.', 'prefix' => 'admin', 'middleware' => 'auth', 'middleware' => 'verified'], function () {
    ...
    Route::get('device/showParameterData/{device_id}/{parameter_id}', [DeviceController::class, 'showParameterData'])->middleware('can:isAdminOrUser')->name('device.showParameterData');
    Route::get('device/showParameterDataWithDate/{device_id}/{parameter_id}/{from}/{to}', [DeviceController::class, 'showParameterDataWithDate'])->middleware('can:isAdminOrUser')->name('device.showParameterDataWithDate');
