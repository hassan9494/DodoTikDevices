...
@section('content')
    ...
    <form action="{{ route('admin.device_parameters.update_color_range',$parameter->id) }}" method="POST">
        @csrf
                                ...
                                <div class="row">
                                    @foreach($parameter->parameterRangeColors as $key=>$range)
                                        <div class="col-md-2">
                                            ...
                                            <div class="col-sm-12" id="level_nameDiv{{$key+1}}">
                                                <input type="text" name="level_name[]" placeholder="level name" id="level_name"
                                                       ...
                                                       value="{{old('level_name[]') ? old('level_name[]') : $range->level_name}}">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="col-sm-12" id="descriptionDiv{{$key+1}}">
                                            <textarea  name="description[]" rows="1" placeholder="description" id="description"
                                                       class="form-control {{$errors->first('description') ? "is-invalid" : "" }} "
                                            >{{old('description[]') ? old('description[]') : $range->description}}</textarea>
                                                <div class="invalid-feedback">
...
@push('scripts')
    ...
    <script>
        function addKeyValue() {
            var rangCount = {!! json_encode(count($parameter->parameterRangeColors), JSON_HEX_TAG) !!};
            console.log(rangCount)
            //////////////start add level name input ////////////////
            var addid = 1;
            var addList = document.getElementById('level_nameDiv'+rangCount);
            ...
            var addid1 = 1;
            var addList1 = document.getElementById('fromDiv'+rangCount);
            ...
            //////////////start add to input ////////////////
            var addid2 = 1;
            var addList2 = document.getElementById('toDiv'+rangCount);
            ...
            var addid3 = 1;
            var addList3 = document.getElementById('colorDiv'+rangCount);
            ...
            var addid4 = 1;
            var addList4 = document.getElementById('descriptionDiv'+rangCount);
