                        ...
                        <ul class="nav nav-pills nav-pills-sm nav-dark-75 nav nav-test flowchart-nav" role="tablist">
                            ...
                            <li class="nav-item nav-item">
                                <a href="#" role="tab"
                                   ...
                                   class="nav-link py-2 px-4  nav-link {{@$label == 1 ? "active" : ""}} ">{{__('message.This Day')}}</a>
                            </li>
                        </ul>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <label for="from" class="form-label"
                                       style="color: #00989d">{{__('message.From')}}</label>
                            ...
                            <div class="col-md-2">
                                ...
                                <button class="btn btn-primary" onclick="getData()"
                                        style="color: #b5b5c3;background: #00989d;border-color: #00989d;">get data
                                </button>
                            </div>
                        </div>
    ...
    <script>
        ...
        for (let i = 0; i < el.length; i++) {
            el[i].onclick = function () {
                ...
                if (el[i].getAttribute('tabindex') == 0) {
                    ...
                    too = 0;
                    jQuery.ajax({
                        url: '/admin/files/showWithDate/{{@$ftpFile->id}}/' + 1 + '/' + 0,
                        type: 'GET',
                    ...
                    too = 0;
                    jQuery.ajax({
                        url: '/admin/files/showWithDate/{{@$ftpFile->id}}/' + fromm + '/' + too,
                        type: 'GET',
                        success: function (data) {
                            console.log(data[0][0])
                            console.log(data[1])
        ...
        document.addEventListener('DOMContentLoaded', function () {
            $('#to').change(function (e) {
                ...
                jQuery.ajax({
                    url: '/admin/files/showWithDate/{{@$device->id}}/' + diffDays1 + '/' + diffDays,
                    type: 'GET',
                    success: function (data) {
        ...
        function getData(){
            ...
            jQuery.ajax({
                url: '/admin/files/showWithDate/{{@$ftpFile->id}}/' + diffDays1 + '/' + diffDays,
                type: 'GET',
                success: function (data) {
