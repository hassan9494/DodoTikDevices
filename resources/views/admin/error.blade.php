                ...
                <div class="card card-custom mb-4">
                    <div class="card-header border-0 pt-5">
                        <h3 class="card-title align-items-start flex-column">
                            <span
                                class="card-label font-weight-bolder text-dark">{{__('message.Error')}}</span>
                        </h3>
                    </div>
                    <div class="card-body pt-2" style="position: relative;">
                        <div class="col-md-12 " style="margin-top: 15px;margin-bottom: 15px">
                            <p>
                                Something went wrong in: <span>{{$error->getFile()}}</span> <br>
                                At line : <span>{{$error->getLine()}}</span><br>
                                The Code of Error is : <span>{{$error->getCode()}}</span><br>
                                Which mean : <span>{{$error->getMessage()}}</span>
                            </p>
                        </div>
                    </div>
                </div>
